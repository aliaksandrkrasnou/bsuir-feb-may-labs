...
function getRegexForGuid() {
	var re = /{[0-9A-Fa-f]{4}(?:[0-9A-Fa-f]{4}-){4}[0-9A-Fa-f]{12}}/;
	//x{n} == x{n}?
	return re;
}
...
function getRegexForIPv4() {
   var reee = /^((?:25[0-5])|(?:2[0-4][0-9])|(?:[01]?\d{1,2}))(?:\.((?:25[0-5])|(?:2[0-4][0-9])|(?:[01]?\d{1,2}))){2}(?:\.((?:25[0-5])|(?:2[0-4][0-9])|(?:[01]?\d{1,2})))$/;
   //var reee = /^((?:25[0-5])|(?:2[0-4][0-9])|(?:[0-1]?\d{1-2}))(?:\.\1){3}/;
   return reee;
}
...
function getRegexForSSN() {
	var reee = /\d{3}(?<!000)-\d{2}(?<!00)-\d{4}(?<!0000)/;
	return reee;
}
...
function getPasswordValidator(minLength) {
	var reeee = new RegExp('^[0-9a-zA-Z]{' + minLength + ',}(?<=[0-9a-zA-Z]*[a-z][0-9a-zA-Z]*)(?<=[0-9a-zA-Z]*[A-Z][0-9a-zA-Z]*)(?<=[0-9a-zA-Z]*[0-9][0-9a-zA-Z]*)$');
   return reeee;
}
