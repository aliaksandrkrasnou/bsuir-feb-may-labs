...
function getRectangleString(width, height) {	
	let i = height - 2;	
	let cubeFace = '';
	let partVertex = cubeFace.padStart(width - 2, '─');
	if (i > 0) {
		let partFace = cubeFace.padStart(width - 2, ' ');	
		partFace = '│ │\n'.replace(' ', partFace);
		while(i > 0) {
			cubeFace += partFace;
			i--;
...
function isString(value) {
	return Object.prototype.toString.call(value).indexOf('String') + 1? true : false;
